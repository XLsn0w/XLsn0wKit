...
+ (UIImage *)createNonInterpolatedUIImageFormCIImage:(CIImage *)image withSize:(CGFloat) size
{
    ...
    UIImage *blockImage = [UIImage imageWithCGImage:scaledImage];
    
    // 3. 设置二维码颜色
    UIImage *newImage = [self imageBlackToTransparent:blockImage withRed:105.0f andGreen:23.0f andBlue:25.0f];
