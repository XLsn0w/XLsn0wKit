...
+ (XLsn0wImage *)imageNamed:(NSString *)name {
...
+ (XLsn0wImage *)imageWithContentsOfFile:(NSString *)path {
    return [[self alloc] initWithContentsOfFile:path];
}

+ (XLsn0wImage *)imageWithData:(NSData *)data {
    return [[self alloc] initWithData:data];
}

+ (XLsn0wImage *)imageWithData:(NSData *)data scale:(CGFloat)scale {
    return [[self alloc] initWithData:data scale:scale];
}
