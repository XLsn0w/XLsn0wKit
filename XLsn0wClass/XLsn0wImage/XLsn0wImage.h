 ...
 */
@interface XLsn0wImage : UIImage <YYAnimatedImage>

+ (nullable XLsn0wImage *)imageNamed:(NSString *)name; // no cache!
+ (nullable XLsn0wImage *)imageWithContentsOfFile:(NSString *)path;
+ (nullable XLsn0wImage *)imageWithData:(NSData *)data;
+ (nullable XLsn0wImage *)imageWithData:(NSData *)data scale:(CGFloat)scale;
